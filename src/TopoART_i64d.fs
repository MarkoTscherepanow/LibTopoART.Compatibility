...
//----------------------------------------------------------------------------------------------------------------------
    ...
    new(inputLen : int64, moduleNum : int64, rho_a : double, t_max : int64) = {
        net = (Internal.NetID.Fast_Episodic_TopoART, new Fast_Episodic_TopoART(inputLen, moduleNum, decimal rho_a, t_max) :> ITopoART)
    }
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    member x.ClusterNum = (snd x.net).ClusterNum
    ...
    /// </exception>
    member x.T_max = double ((snd x.net) :?> IEpisodic_TopoART).T_max
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    /// <exception cref="InvalidNumberException">Throws when the number of edges of an F2 node is greater than
    /// <c>int.MaxValue</c>.</exception>
    member x.GetAdaptationState(epsilon : double) =
